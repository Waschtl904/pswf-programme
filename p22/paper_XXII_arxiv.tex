...
%%
%% STRUCTURAL ADDITIONS (not patches — inherent architecture):
%%   [S1] §1.4: Proposition — why Widom is insufficient (category shift)
%%   [S2] §3.1: Remark — TW determinant -> operator norm identity (3 lines)
%%   [S3] App.B: Remark — K-rank vs M-count separation (1 sentence)
%%   [S4] §1.5: Remark — Airy universality class rigidity (why TW is forced)
%%
